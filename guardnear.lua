...
function cmdAv()
    ...
    if ActivateAv then
        sampAddChatMessage("{901A00}TEST {FFFFFF}| {1E90FF}[Autovest]: {FFFFFF}Auto accept vest has been Enabled")
    else
        sampAddChatMessage("{901A00}TEST {FFFFFF}| {1E90FF}[Autovest]: {FFFFFF}Auto accept vest has been Disabled")
    end
    if ActivateAv then
